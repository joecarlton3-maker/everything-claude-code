...
def run_backtest(
    ...
    *,
    ...
    if cfg.exit_mode == "single_target":
        # Lazy import — vectorbt is heavy and only needed in single-target mode.
        from ..strategy.vbt_simulator import simulate_vbt_single_target
        sim = simulate_vbt_single_target(
            df=df,
